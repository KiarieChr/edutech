...
class ApplicationViewSet(viewsets.ModelViewSet):
    ...
    def admit(self, request, pk=None):
        ...
        # Strict admission into the globally CURRENT term
        term = Term.objects.filter(is_current=True).first()
        if not term:
             raise serializers.ValidationError('No term is currently set as active/current in the system. Cannot process admission.')
