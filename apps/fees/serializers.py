...
class FeeInvoiceItemSerializer(serializers.ModelSerializer):
    ...
    gl_account = serializers.CharField(source='fee_item.account.name', read_only=True)

    class Meta:
        model = FeeInvoiceItem
        fields = ['id', 'fee_category', 'fee_item_name', 'description', 'amount', 'amount_paid', 'balance', 'is_mandatory', 'gl_account']
