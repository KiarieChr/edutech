...
from student_management.viewsets import ApplicationViewSet, AdmissionViewSet, StudentPlacementViewSet

router = DefaultRouter()
router.register(r'applications', ApplicationViewSet)
router.register(r'admissions', AdmissionViewSet)
router.register(r'placements', StudentPlacementViewSet)
