...
class TimePeriodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_schedulable', 'applies_to_days',
...
class TeacherAvailabilitySerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if recurrence == 'once' and not data.get('date_from'):
            raise serializers.ValidationError({
                'date_from': 'A start date is required for one-time unavailability.'
            })
...
class TimetableVersionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'class_session', 'class_session_name',
            'version_number', 'name', 'description',
            'slot_data', 'total_slots',
            'created_by', 'created_by_name', 'created_at',
            'was_restored', 'restored_at',
        ]
        read_only_fields = [
            'version_number', 'slot_data', 'total_slots',
            'created_by', 'created_at', 'was_restored', 'restored_at',
        ]
...
class TimetableVersionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'class_session', 'class_session_name',
            'version_number', 'name', 'description',
            'total_slots', 'created_by_name', 'created_at',
            'was_restored',
        ]
